...
public class RememberMe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  String rememberMe = request.getParameter("remember_me");  // checkbox의 체크가 없으면 null
	  
	  // 아이디 기억하기 체크했다면 쿠키에 id를 저장한다.
	  Cookie cookie = null;
	  if(rememberMe != null) {  // if(rememberMe.equals("on")){ 과 동일함
	    cookie = new Cookie("rememberMe", id);
